...
def main():
    ...
    prompt = (
        f"Ты метеоролог.Сделай аналитику: "
        ...
        f"Объясни метеоситуацию, используй эмодзи 🛰️, 🌡️, 🧲."
    )
    ...
    for model in models:
        try:
            ...
            response = requests.post(
                ...
                json={
                    "model": model,
                    "messages": [{"role": "system", "content": "Ты метеоролог.Опиши кратко текущую глобальную обстановку и дай прогноз."}, {"role": "user", "content": prompt}],
                    "temperature": 0.7
                }, timeout=45)
