...
def main():
    ...
    # 2. АНАЛИТИКА
        ...
        prompts = {
            ...
            "#прогнозвечер": f"Ты метеоролог-аналитик профи 👨‍🔬. Сейчас вечер 🌙. На основе данных: {data_str} сделай КРАТКУЮ сводку на вечер, ночь и утро. Кратко объясни  какие воздушные массы (циклоны/антициклоныи их название) влияют на Пинск и Палесье и какие изменения принесёт 🌀☀️. Стиль: кратко,без воды,всегда указывай числовые значения и расшифровки для сводки, эмодзи вставляй в начало, походящие по смыслу 🌠🛰️📉🧊☔🌀☀️🌡️🧲🌨️🧤☁️💨🇧🇾🌅.",
            "#прогнознеделя": f"Ты метеоролог-аналитик профи 👨‍🔬. Воскресенье 📅. На основе данных на неделю: {day['temperature_2m_max']} сделай КРАТКУЮ сводку на каждый день недели. Сделай СЖАТУЮ аналитику. Опиши смену воздушных масс, циклоны/антициклоны (и их название) и их влияние на Палесье и какие изменения принесёт 🇧🇾.Стиль:кратко, без воды, всегда указывай числовые значения и расшифровки для сводки,эмодзи вставляй в начало, походящие по смыслу 🛰️📉🧊☔🌀☀️🌡️🧲🌨️🧤☁️💨🇧🇾🌅."
        }
