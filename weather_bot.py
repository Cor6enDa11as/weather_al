...
def get_weather_desc(code):
    # Коды WMO для определения типа осадков
    codes = {
...
def main():
    ...
    # 1. ДЕЖУРКА (#прогноз) - Кратко и профессионально
    if 7 <= hour <= 19:
        msg = (f"#прогноз\n\n"
    ...
    # 2. АНАЛИТИКА
        ...
        # Обновленные промпты с требованием краткости и проф. терминов
        prompts = {
            "#прогнозутро": f"Ты метеоролог-аналитик профи 👨‍🔬. Сейчас утро 🌅. На основе данных: {data_str} сделай КРАТКУЮ сводку на утро и день. Данные о темп. (реальной и ощущаемой 🧤), осадках (тип/время) 🌨️, качестве воздуха 🍃 и восходе. Кратко объясни глобальный фон: какие воздушные массы (циклоны/антициклоны и их название) влияют на Пинск и Палесье и какие изменения принесёт 🇧🇾🚣‍♂️.Стиль:кратко, без воды,всегда указывай числовые значения и расшифровки, эмодзи вставляй в начало, походящие по смыслу 🛰️📉🧊☔🌀☀️🌡️🧲🌨️🧤☁️💨🇧🇾🌅🌬️.",
            "#прогнозвечер": f"Ты метеоролог-аналитик профи 👨‍🔬. Сейчас вечер 🌙. На основе данных: {data_str} сделай МАКСИМАЛЬНО КРАТКУЮ сводку на вечер, ночь и утро. Кратко объясни глобальный фон: какие воздушные массы (циклоны/антициклоны) влияют на Пинск и Палесье и какие изменения принесёт 🌀☀️. Стиль: кратко,без воды,всегда указывай числовые значения и расшифровки, эмодзи вставляй в начало, походящие по смыслу 🌠🛰️📉🧊☔🌀☀️🌡️🧲🌨️🧤☁️💨🇧🇾🌅.",
            "#прогнознеделя": f"Ты метеоролог-аналитик профи 👨‍🔬. Воскресенье 📅. На основе данных на неделю: {day['temperature_2m_max']} сделай МАКСИМАЛЬНО КРАТКУЮ сводку на каждый день недели. Сделай СЖАТУЮ аналитику. Опиши смену воздушных масс, циклоны/антициклоны и их влияние на Палесье и какие изменения принесёт 🇧🇾.Стиль:кратко, без воды, всегда указывай числовые значения и расшифровки,эмодзи вставляй в начало, походящие по смыслу 🛰️📉🧊☔🌀☀️🌡️🧲🌨️🧤☁️💨🇧🇾🌅."
        }
