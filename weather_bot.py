...
def main():
    ...
    try:
        ...
        # Пробуем разные варианты ключей, которые использует NOAA
        if '0' in kp_res and 'mag_eff' in kp_res['0']:
            kp = float(kp_res['0']['mag_eff']['kp'])
        else:
            # Если структура изменилась, берем первый попавшийся Kp из числовых значений
